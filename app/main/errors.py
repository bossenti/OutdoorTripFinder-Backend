...
def page_not_found(e):
    return make_response(create_response(SERVER_ERROR_404, "", None))


@main_app.app_errorhandler(500)
def internal_server_error(e):
    return make_response(create_response(SERVER_ERROR_500, "", None))


@main_app.app_errorhandler(400)
def bad_request(e):
    return make_response(create_response(BAD_REQUEST_400, "", None))
